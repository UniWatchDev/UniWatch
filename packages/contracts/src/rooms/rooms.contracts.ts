import {
  ROOMS_ENDPOINT,
  ROOM_ENDPOINT,
  ROOM_PREVIEW_ENDPOINT,
  ROOM_JOIN_ENDPOINT,
  ROOM_LEAVE_ENDPOINT,
  ROOM_BLOCKED_USERS_ENDPOINT,
  ROOM_BLOCKED_USER_ENDPOINT
} from '@repo/consts/rooms';
import {
...
export const listBlockedUsersContract: EndpointContract<BlockedUsersResponse, void, RoomIdParams> = {
  method: 'GET',
...
export const unblockUserContract: EndpointContract<BlockedUsersResponse, void, RoomBlockedUserParams> = {
  method: 'DELETE',
